...
public class Main {
    ...
    public void executeOption(int option) {
        ...
        switch (option) {
            ...
            case 2:
                ...
                String formattedTime = String.format("%02d:%02d:%02d", timeBuy.getHour(), timeBuy.getMinute(),
                        timeBuy.getSecond());
            ...
            case 5:
                ...
                if (typE < 1 || typE > 2) {
                    ...
                    System.out.println("Desea buscar su orden por un rango de:\n" +
                            ...
                            "3. numero de veces comprado\n ");
                    int op = reader.nextInt();
                    if (op < 1 || op > 3) {
                        System.out.println("porfavor ingresa una opcion valido");
                    } else {
                        ...
                        System.out.println(controller.searchRangeProductNumeric(numin, nummax, op, type2));

                    }
                } else {
                    System.out.println(
                            "porfavor ingrese la letra o prefijo  inicial con la que se va a hacer la busqueda");
                    prefint = reader.next();
                    System.out
                            .println("porfavor ingrese la letra o prefijo  final con la que se va a hacer la busqueda");
                    prefend = reader.next();
                    msj = controller.searchPrefProduct(prefint, prefend);
                    System.out.println(msj);
    ...
    /**
     * validateIntegerInput: this method validates that the option entered by the
     * user is actually an integer data type
     * 
